...
@push('admin_head')
<style>
    .br-detail{padding:24px 32px 40px}.br-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px}.br-card{background:#fff;border:1px solid rgba(0,0,0,.12);border-radius:8px;padding:18px;box-shadow:0 2px 8px rgba(0,0,0,.06)}.br-card h2{font-size:18px;margin-bottom:14px}.br-meta{display:grid;grid-template-columns:180px 1fr;gap:8px;font-size:14px}.br-summary{display:grid;grid-template-columns:repeat(4,1fr);gap:10px}.br-stat{border:1px solid #eee;border-radius:8px;padding:12px}.br-stat span{color:#666;font-size:12px;font-weight:600}.br-stat strong{display:block;color:#9f1010;font-size:22px}.br-table td,.br-table th{font-size:13px;vertical-align:middle}.br-actions{display:flex;gap:8px;flex-wrap:wrap}@media(max-width:900px){.br-grid,.br-summary{grid-template-columns:1fr}.br-detail{padding:16px}.br-meta{grid-template-columns:1fr}}
</style>
@endpush
